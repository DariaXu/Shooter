...
public:	
	...
	class UTexture2D* CrosshairsCenter; // forward declaring
	...
	// Zoomed FOV while aiming, will be changed for different weapons
...
private:
	UPROPERTY(VisibleAnywhere, Category="Weapon Propereties")
